...
df_cannibalized.to_csv(f'csv/df_cannibalized_{device_category}.csv', encoding='utf-8', index=False)
...
df_cannibalized.to_csv('csv/df_cannibalized_with_meta.csv', encoding='utf-8', index=False)
